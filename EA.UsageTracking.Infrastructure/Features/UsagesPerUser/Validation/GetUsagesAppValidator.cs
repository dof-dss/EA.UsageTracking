...
{
    public class GetUsagesAppValidator: AbstractValidator<GetUsagesAppQuery>
    {
        public GetUsagesAppValidator()
        {
            RuleFor(q => q.ApplicationId).GreaterThanOrEqualTo(1).WithMessage(Constants.ErrorMessages.NoTenant);
